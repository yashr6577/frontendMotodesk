...
function AdminInventoryContent() {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      try {
        const response = await fetch("https://motodesk-web.onrender.com/order/getOrder");
    ...
    const fetchInventory = async () => {
      try {
        const response = await fetch("https://motodesk-web.onrender.com/inventory/"); // Adjust the endpoint as needed
        const data = await response.json();
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("hhttps://motodesk-web.onrender.com/price/add", {
        method: "POST",
        headers: {
  ...
  const handleAcceptOrder = async (orderId) => {
    try {
      const response = await fetch(`https://motodesk-web.onrender.com/order/order/update/confirmed/${orderId}`, {
        method: "POST",
      });

      if (response.ok) {
        // Fetch updated orders after accepting
        const updatedOrdersResponse = await fetch("https://motodesk-web.onrender.com/order/getOrder");
  ...
  const handleDeliverOrder = async (orderId) => {
    try {
      const response = await fetch(`hhttps://motodesk-web.onrender.com/order/order/update/delivered/${orderId}`, {
        method: "POST",
      });
